...
public class SecurityConfig {
    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .csrf(csrf -> csrf.ignoringRequestMatchers("/register", "/h2-console/**"))
    ...
    public RegisteredClientRepository registeredClientRepository(PasswordEncoder passwordEncoder) {
        ...
        String encodedClientSecret = passwordEncoder.encode("todo-client-secret");
        ...
        RegisteredClient todoClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("http://127.0.0.1:8081/login/oauth2/code/todo-client")
                .scope(OidcScopes.OPENID)
                .scope(OidcScopes.PROFILE)
                .scope("todo.read")
                .scope("todo.write")
                .clientSettings(ClientSettings.builder()
                        .requireAuthorizationConsent(false) // Set to false for easier testing
                        .build())
